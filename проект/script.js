...
let nesDiv = document.getElementById("nes-div");
let nesText = document.getElementById("nes-text");

nesDiv.addEventListener('mouseenter', () => nesText.classList.add("hover-country-text"));
nesDiv.addEventListener('mouseleave', () => nesText.classList.remove("hover-country-text"));
...
document.getElementById('plov-div').addEventListener('click', function() {
    window.location.href = 'plovdiv.html';
});
document.getElementById('kopriv-div').addEventListener('click', function() {
    window.location.href = 'koprivshtisa.html';
});
